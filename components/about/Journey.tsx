        ...
        <div className="flex flex-col md:flex-row md:justify-center gap-12 md:gap-8">
          {milestones.map((m, i) => (
            <motion.div
              ...
              className="relative flex flex-col items-center text-center bg-white/90 dark:bg-neutral-900/90 rounded-3xl p-8 shadow-xl border-0 min-w-[260px] max-w-xs mx-auto group hover:scale-105 hover:shadow-2xl transition-all duration-300"
            >
              ...
              <p className="text-muted-foreground text-base mb-2">{m.description}</p>
            </motion.div>
          ))}
        </div>
      </div>

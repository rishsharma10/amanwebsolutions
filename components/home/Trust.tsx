...
import { Globe, Building2, Code2, Briefcase, Award } from 'lucide-react';
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="relative aspect-video rounded-2xl overflow-hidden border border-white/10 bg-[#0a0a0f] shadow-2xl">
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=1000')] bg-cover bg-center opacity-30 mix-blend-luminosity" />
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="glass-morphism rounded-xl p-4 border border-white/5 backdrop-blur-md">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <div className="text-xs text-brand-cyan font-mono">LIVE</div>
                  </div>
